...
4. 목적 드롭다운 메뉴에서 파일 시스템의 블록 장치를 선택합니다.<br>이 구성을 사용하면 볼륨 그룹에 포함된 모든 드라이브의 용량 합계에 해당하는 최대 볼륨 크기를 가진 논리 볼륨을 생성할 수 있습니다.
...
1. 논리 볼륨 섹션의 씬 볼륨을 위함 풀의 씬 볼륨 만들기 버튼을 클릭합니다
