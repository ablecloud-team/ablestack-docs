...
6. 클라우드센터 Zone 서비스용 네트워크 정보
    ...
    - **케이트웨이** 항목에는 **10.10.0.1**, **넷마스크** 항목에는 **255.255.0.0**, **시작 IP 주소** 항목에는 **10.10.2.101**, 
    **종료 IP 주소** 항목에는 **10.10.2.150**을 입력하고 **추가** 버튼을 클릭합니다.
    - 입력한 정보를 확인 후 **다음** 버튼을 클릭합니다.
...
7. 클라우드센터 Pod 네트워크 정보
    ...
    - **예약된 시스템 시작 IP 주소** 항목에는 **10.10.2.21** 을 입력합니다.
    - **예약된 시스템 종료 IP 주소** 항목에는 **10.10.2.31** 을 입력합니다.
    - 입력한 정보를 확인 후 **다음** 버튼을 클릭합니다.
