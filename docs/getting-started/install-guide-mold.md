...
1. 스토리지센터 웹콘솔
    ![스토리지센터 웹콘솔](../assets/images/install-guide-mold-storage-webconsole.png)
    - NFS를 구성하기 위해서 스토리지센터 웹콘솔에 접속합니다.
    
2. Namespace 생성
    ![Namespace 생성](../assets/images/install-guide-mold-namespace-create.png)
...
3. Namespace 생성 완료
    ![Namespace 생성 완료](../assets/images/install-guide-mold-namespace-create-completed.png)
    - Namespace 가 정상적으로 생성 완료 확인하기 위한 화면입니다.
    
4. NFS-ganesha 설정
    ![NFS-ganesha 설정](../assets/images/install-guide-mold-NFS-ganesha-config.png)
    ...
    ```
5. RGW 서비스 생성
    ![서비스](../assets/images/install-guide-mold-service.png)
    - 서비스를 확인하는 화면입니다. **Cluster > Services** 화면에서 **Create** 버튼을 클릭 합니다.
    ![RGW 서비스 생성](../assets/images/install-guide-mold-RGW-service-create.png)
    - RGW 서비스를 생성하는 화면입니다.  
...
6. RGW 서비스 생성 확인
    ![RGW 서비스 생성 확인](../assets/images/install-guide-mold-RGW-service-create-completed.png)
    - RGW 서비스 생성 확인하는 화면 입니다. 리스트에서 생성한 서비스가 정상적으로 보이는지 확인하시면 됩니다.
    
7. NFS Pool 생성
    ![NFS Pool 생성](../assets/images/install-guide-mold-NFS-Pool-create.png)
...
8. cephfs 볼륨 생성
    ![cephfs 볼륨 생성](../assets/images/install-guide-mold-cephfs-volume-create.png)
...
9. NFS Quotas 설정
    ![NFS Quotas 설정](../assets/images/install-guide-mold-NFS-Quotas-config.png)
    ...
    ![ha 디렉토리 설정](../assets/images/install-guide-mold-ha-directory-config.png)
    - ha 디렉토리 Quotas 설정 확인   
    ![secondary 디렉토리 설정](../assets/images/install-guide-mold-secondary-directory-config.png)
    - ha 디렉토리 Quotas 설정 확인
    
10. NFS 서비스 생성
    ![NFS 서비스 생성](../assets/images/install-guide-mold-NFS-service-create.png)
    ...
    ![NFS 서비스 생성 확인](../assets/images/install-guide-mold-NFS-service-create-check.png)
    - **Services** 메뉴를 클릭하여 생성한 서비스가 정상적인지 리스트에서 확인합니다.

11. NFS Export 설정  
    ![NFS Export 설정 - ha](../assets/images/install-guide-mold-NFS-Export-config-ha.png)  
    - ha 디렉토리 NFS Export 설정하는 화면입니다.  
    
    ![NFS Export 설정 - secondary](../assets/images/install-guide-mold-NFS-Export-config-secondary.png)  
...
12. NFS Export 설정 확인
    ![NFS Export 설정 확인](../assets/images/install-guide-mold-NFS-Export-config-check.png)
...
1. 클라우드센터 가상머신 접속
    ![클라우드센터 가상머신 접속](../assets/images/install-guide-mold-cloudcenter-VM-connect.png){ align=center }
...
2. NFS 마운트
    ![NFS 마운트](../assets/images/install-guide-mold-nfs-mount.png){ align=center }
...
3. System VM용 Template 등록
    ![System VM 용 Template 등록](../assets/images/install-guide-mold-System-VM-Template-regist.png){ align=center }
...
3. 클라우드센터 Zone 유형 선택
    ![클라우드센터 Zone Type 선택](../assets/images/install-guide-mold-cloudcenter-select-Zone.png){ align=center }
