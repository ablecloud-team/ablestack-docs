...
2. 클러스터 종류
    ![클러스터 종류](../assets/images/install-guide-glue-02-1.png){ .imgCenter .imgBorder }
    - 클러스터 종류를 설정하는 화면입니다.
...
2. 클러스터 종류
    ![클러스터 종류](../assets/images/install-guide-glue-18-1.png){ .imgCenter .imgBorder }
    - 클러스터 종류를 설정하는 화면입니다.
    - **ABLESTACK-HCI** 를 선택합니다.
    - **다음** 버튼을 클릭하여 클러스터 종류를 선택합니다.
...
2. 클러스터 종류
    ![클러스터 종류](../assets/images/install-guide-glue-34-1.png){ .imgCenter .imgBorder }
    - 클러스터 종류를 설정하는 화면입니다.
    - **ABLESTACK-HCI** 를 선택합니다.
    - **다음** 버튼을 클릭하여 클러스터 종류를 선택합니다.
...
8. ABLESTACK 확인
    ![ABLESTACK 확인](../assets/images/install-guide-glue-ABLESTACK-check.png){ .imgCenter .imgBorder }
