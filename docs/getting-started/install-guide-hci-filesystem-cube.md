...
# ABLESTACK HCI File System Cube 설치진행

!!! danger
    이 문서는 기술지원 용도의 문서입니다. 기술지원 엔지니어가 아닌 사용자가 조작할 때 시스템에 문제가 발생할 수 있습니다.

ABLESTACK HCI File System Cube를 설치 진행 가이드 입니다.
...
!!! info
    ...
    - ABLESTACK HCI File System Cube 설치시 ABLESTACK Cell이 동시에 설치가 진행되며, ABLESTACK Cell의 설치가이드는 따로 제공 되고 있지 않습니다.
...
## ABLESTACK HCI File System Cube 설치 진행 가이드

1. ABLESTACK ISO를 이용한 USB 부팅 화면 입니다.
    ![ABLESTACK HCI File System Cube 부팅화면](../assets/images/install-guide-cube-01.png){ .imgCenter .imgBorder }

2. 부팅 완료 후 ABLESTACK 설치 메뉴 화면 입니다.
    정상적으로 ISO 또는 USB를 이용하여 정상적으로 부팅되면 아래와 같은 이미지의 화면으로 전환됩니다.
    ![ABLESTACK HCI File System Cube 설치 메뉴화면](../assets/images/install-guide-cube-02.png){ .imgCenter .imgBorder }

    !!! Check
        화면에서 **Install ABLESTACK Diplo** 메뉴가 보이는지 확인해야 합니다. 해당 메뉴가 보이면 ABLESTACK HCI File System Cube 정상적으로 설치를 하실 수 있습니다.</br>
        만약 해당 메뉴가 보이지 않는다면 정상적인 부팅이 되지 않은 경우이므로 부팅매체를 확인하고 재부팅을 해야 합니다.</br>
        다시 한번 부팅해도 해당 메뉴가 보이지 않는다면 ISO 또는 USB가 손상되었을 수 있습니다.

3. ABLESTACK HCI File System Cube 구성 화면 입니다.
    ![ABLESTACK HCI File System Cube 구성 화면](../assets/images/install-guide-cube-03.png){ .imgCenter .imgBorder }

    !!! info
        ABLESTACK HCI File System Cube는 기본적인 정보는 자동으로 설정이 되어 있습니다.
...
4. 네트워크 및 호스트 이름 구성변경 화면
    - ABLESTACK HCI File System Cube 구성화면에서 **Network & Host Name** 을 클릭하면 해당 화면으로 이동됩니다.
...
5. 설치 대상 구성 화면
    - ABLESTACK HCI File System Cube 구성화면에서 **Installation Destination** 을 클릭하면 해당 화면으로 이동됩니다.
...
7. ABLESTACK HCI File System Cube 구성 마무리
    ![ABLESTACK HCI File System Cube 구성 마무리](../assets/images/install-guide-cube-12.png){ .imgCenter .imgBorder }
    - ABLESTACK HCI File System Cube 설정 완료 후 **Begin installation** 버튼을 클릭하여 ABLESTACK 설치를 진행 합니다.

    ![ABLESTACK HCI File System Cube 구성 마무리](../assets/images/install-guide-cube-12-1.png){ .imgCenter .imgBorder }

    - 설치가 완료가 되면 자동으로 재부팅 절차가 진행되며 연결되어 있는 ABLESTACK ISO 또는 USB를 제거하여 ABLESTACK HCI File System Cube 설치를 마무리 합니다.

    ![ABLESTACK HCI File System Cube 설치완료](../assets/images/install-guide-cube-13.png){ .imgCenter .imgBorder }
    - 설치가 정상적으로 완료되면 ABLESTACK 콘솔 로그인 화면이 보이게 됩니다.
!!! note
    ABLESTACK Diplo 버전부터는 콘솔화면에 대한 GUI 환경, CLI 환경 둘 중 하나를 선택할 수 있습니다.

## ABLESTACK HCI File System Cube Network 셋팅
!!! check
...
### Intel NIC 일 경우
1. ABLESTACK HCI File System Cube 로그인
    ![ABLESTACK HCI File System Cube 로그인](../assets/images/install-guide-cube-14.png){ .imgCenter .imgBorder }
    - ABLESTACK HCI File System Cube 로그인 화면입니다.
    - 접속 URL은 **호스트IP:9090** 입니다
    - 사용자 이름은 **root** 를 암호는 초기 암호를 입력하여, 원하시는 비밀번호로 변경한 후, **로그인** 버튼을 클릭하면 로그인 하실 수 있습니다.

2. ABLESTACK HCI File System Cube 메인 화면
    ![ABLESTACK HCI File System Cube 메인 화면](../assets/images/install-guide-cube-15.png){ .imgCenter .imgBorder }
    - ABLESTACK HCI File System Cube 로그인 후 화면입니다.

3. ABLESTACK HCI File System Cube 네트워킹 구성
    ![ABLESTACK HCI File System Cube 네트워킹 구성](../assets/images/install-guide-cube-16.png){ .imgCenter .imgBorder }
    - ABLESTACK HCI File System Cube 네트워킹 구성 화면입니다. </br>해당 화면에서 방화벽 설정 및 본드(bond), 브릿지(bridge), VLAN 구성을 진행합니다.
    ...
    2. Management Network 브릿지 설정
        ...
        !!! info
            ...
            브릿지의 IP 설정은 ABLESTACK HCI File System Cube 구성하면서 입력된 IP 정보가 상속되여 자동으로 설정됩니다.
...
!!! info
    ...
    ABLESTACK HCI File System Cube 설치 진행절차는 2번, 3번 호스트도 동일합니다. 위 설치 절차를 2번, 3번 호스트에도 진행하시기 바랍니다.

!!! check
    ABLESTACK HCI File System Cube 및 ABLESTACK Cell의 설치 및 구성이 끝났습니다.
