ABLESTACK은 소프트웨어 스택을 상용 x86 서버에 설치하여 구성합니다. 상용 x86 서버를 지원하기 때문에 서버에 장착되는 다양한 하드웨어에 대한 폭넓은 유연성을 갖고 있습니다. ABLESTACK을 설치하는 물리적인 서버는 사용 목적이나 규모에 따라 다음과 같이 나눌 수 있습니다. 
