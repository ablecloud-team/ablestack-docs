...
## 컴퓨트 오퍼링 코멘트 탭
1. 컴퓨트 오퍼링 목록 조회에서 확인하고 싶은 컴퓨트 오퍼링 목록을 조회합니다. 컴퓨트 오퍼링과 관련된 코멘트 정보를 확인하는 화면입니다. 각 사용자별로 해당 컴퓨트 오퍼링에 대한 코멘트 정보를 조회 및 관리할 수 있는 화면입니다.
    ![컴퓨트 오퍼링 코멘트 탭](../../assets/images/admin-guide/mold/offering/compute/compute-offering-coment.png){ .imgCenter .imgBorder }

## 용어사전
<!-- |  용어명      | 옵션 | 설명                        |
| :---------: | :-: | :----------------------------------: |
| 컴퓨트 오퍼링 유형 | 고정 오퍼링 | 사용자가 사용자 정의할 수 없음 |
