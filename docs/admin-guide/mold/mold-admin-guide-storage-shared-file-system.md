...
2. 디스크 오퍼링 변경 버튼을 클릭한 화면입니다.
    ...
    !!! info
        고정 디스크 오퍼링을 선택할 시, 해당 크기는 오퍼링에서 고정으로 할당된 값으로 만들어 집니다.</br></br>
        <span style="font-size:20px">👉 &nbsp;&nbsp;🔗[디스크 오퍼링 생성 가이드](./mold-admin-guide-storage-volume.md/#_3)</span></br>
...
!!! info
    서비스 오퍼링을 변경할 경우, 미리 사전에 생성되어 있어야 합니다.</br></br>
    <span style="font-size:20px">👉 &nbsp;&nbsp;🔗[컴퓨트 오퍼링 생성 가이드](./mold-admin-guide-storage-volume.md/#_3)</span></br>