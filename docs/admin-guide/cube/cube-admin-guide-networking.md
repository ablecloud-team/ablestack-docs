...
본드를 추가하려면 : 
    ![cube-networking-addbond-btn1](../../assets/images/admin-guide/cube/networking/cube-networking-addbond-btn1.png)

1. 네트워킹 메뉴를 클릭합니다.
2. **본드 추가** 버튼을 클릭합니다.

    ![cube-networking-addbond-btn2](../../assets/images/admin-guide/cube/networking/cube-networking-addbond-btn2.png)
...
6. 모드 선택 목록에서 모드를 선택합니다.
    ...
    ![cube-networking-addbond-btn3](../../assets/images/admin-guide/cube/networking/cube-networking-addbond-btn3.png)
...
![cube-networking-addbond3.png](../../assets/images/admin-guide/cube/networking/cube-networking-addbond3.png)
...
![cube-networking-addbond-interface.png](../../assets/images/admin-guide/cube/networking/cube-networking-addbond-interface.png)
...
3. 본드 설정 화면에서 인터페이스를 선택하고 제거하거나 비활성화합니다.
    ...
    ![cube-networking-delbond-interface.png](../../assets/images/admin-guide/cube/networking/cube-networking-delbond-interface.png)
...
![cube-networking-delbond.png](../../assets/images/admin-guide/cube/networking/cube-networking-delbond.png)
...
![cube-networking-addteam-btn1](../../assets/images/admin-guide/cube/networking/cube-networking-addteam-btn1.png)

1. 네트워킹 메뉴를 클릭합니다.
2. **팀 추가** 버튼을 클릭합니다.

    ![cube-networking-addteam-btn2](../../assets/images/admin-guide/cube/networking/cube-networking-addteam-btn2.png)

3. 팀 설정 화면에서 팀 장치의 이름을 추가합니다.
4. 포트 항목에서 팀에 추가 할 모든 네트워크 인터페이스를 선택합니다.
5. 실행자 항목에서 실행자를 선택합니다.
6. 연결 보기 목록에서 링크 보기를 선택합니다.
...
![cube-networking-addteam2.png](../../assets/images/admin-guide/cube/networking/cube-networking-addteam2.png)
...
![cube-networking-addteam-interface.png](../../assets/images/admin-guide/cube/networking/cube-networking-addteam-interface.png)
...
3. 팀 설정 화면에서 인터페이스를 선택하고 제거하거나 비활성화합니다.
    ...
    ![cube-networking-delteam-interface.png](../../assets/images/admin-guide/cube/networking/cube-networking-delteam-interface.png)
...
3. 선택한 팀을 제거하거나 비활성화합니다.
    ...
    ![cube-networking-delteam.png](../../assets/images/admin-guide/cube/networking/cube-networking-delteam.png)
...
브릿지를 추가하려면 : 
    ![cube-networking-addbridge-btn1](../../assets/images/admin-guide/cube/networking/cube-networking-addbridge-btn1.png)

1. 네트워킹 메뉴를 클릭합니다.
2. **브릿지 추가** 버튼을 클릭하십시오.

    ![cube-networking-addbridge-btn2](../../assets/images/admin-guide/cube/networking/cube-networking-addbridge-btn2.png)
...
![cube-networking-addbridge3.png](../../assets/images/admin-guide/cube/networking/cube-networking-addbridge3.png)
...
브릿지를 편집하려면 : 
![cube-networking-updatebridge-btn1](../../assets/images/admin-guide/cube/networking/cube-networking-updatebridge-btn1.png)

1. 네트워킹 메뉴를 클릭합니다.
2. 편집하려는 인터페이스를 선택하고, 브릿지 항목의 **편집** 버튼을 클릭합니다.
3. 설정을 변경 한 후 **적용** 버튼을 클릭합니다.

    ![cube-networking-chg.png](../../assets/images/admin-guide/cube/networking/cube-networking-chg.png)
...
2. 고정 IP 주소를 설정할 인터페이스를 클릭합니다.
    ...
    ![cube-networking-ip.png](../../assets/images/admin-guide/cube/networking/cube-networking-ip.png)

3. 인터페이스 세부 정보 화면에서 IPv4 항목의 **편집** 버튼을 클릭합니다.

    ![cube-networking-ip2.png](../../assets/images/admin-guide/cube/networking/cube-networking-ip2.png)
...
![cube-networking-ip5.png](../../assets/images/admin-guide/cube/networking/cube-networking-ip5.png)
...
3. 브릿지 설정 화면에서 인터페이스를 선택하고 '**-**' 아이콘을 클릭 합니다.
    ...
    ![cube-networking-delbridge-interface.png](../../assets/images/admin-guide/cube/networking/cube-networking-delbridge-interface.png)
...
3. 브릿지 설정 화면에서 **삭제** 버튼을 클릭 합니다.
    ...
    ![cube-networking-delbridge.png](../../assets/images/admin-guide/cube/networking/cube-networking-delbridge.png)
...
VLAN을 추가하려면 :
![cube-networking-addvlan.png](../../assets/images/admin-guide/cube/networking/cube-networking-addvlan.png)
...
5. 이름 항목에서 미리 정의된 이름이 부모 인터페이스와 VLAN ID로 구성되어 볼 수 있습니다. 필요하지 않은 경우 이름을 그대로 둡니다.
    ...
    ![cube-networking-addvlan2.png](../../assets/images/admin-guide/cube/networking/cube-networking-addvlan2.png)

6. **적용** 버튼을 클릭 합니다.

새 VLAN이 생성되었으며 VLAN을 클릭하고 네트워크 설정을 구성해야 합니다.

![cube-networking-addvlan3.png](../../assets/images/admin-guide/cube/networking/cube-networking-addvlan3.png)
...
2. 방화벽 항목 **ON** 클릭하여 방화벽을 실행합니다.
    ...
    ![cube-networking-firewalllist.png](../../assets/images/admin-guide/cube/networking/cube-networking-firewalllist.png)
...
firewalld 트래픽 관리를 단순화하는 영역 및 서비스 개념을 사용합니다. 영역은 미리 정의 된 규칙 집합입니다. 네트워크 인터페이스 및 소스를 영역에 할당 할 수 있습니다. 허용되는 트래픽은 컴퓨터가 연결된 네트워크와 이 네트워크에 할당된 보안 수준에 따라 다릅니다. 방화벽 서비스는 특정 서비스에 대한 수신 트래픽을 허용하는데 필요한 모든 설정을 포함하는 미리 정의 된 규칙이며 영역 내에서 적용됩니다.

서비스는 네트워크 통신을 위해 하나 이상의 포트 또는 주소를 사용합니다. 방화벽은 포트를 기반으로 통신을 필터링합니다. 서비스에 대한 네트워크 트래픽을 허용하려면 해당 포트가 열려 있어야 합니다. firewalld 명시적으로 개방으로 설정되지 않은 포트의 모든 트래픽을 차단합니다. trusted 와 같은 일부 영역은 기본적으로 모든 트래픽을 허용합니다.
...
- **dmz** : 내부 네트워크에 대한 제한된 액세스로 공개적으로 액세스 할 수 있는 dmz에 있는 컴퓨터의 경우. 선택한 수신 연결만 허용됩니다.
...
3. **방화벽** 을 클릭합니다.\
    ...
    ![cube-networking-firewalllist.png](../../assets/images/admin-guide/cube/networking/cube-networking-firewalladd.png)

4. **신규 영역 추가** 버튼을 클릭합니다.
...
![cube-networking-zonelist.png](../../assets/images/admin-guide/cube/networking/cube-networking-zonelist.png)
...
4. 방화벽 항목에서 **서비스 추가** 버튼을 클릭합니다.
    ...
    ![cube-networking-servicelist.png](../../assets/images/admin-guide/cube/networking/cube-networking-servicelist.png)
...
7. 원하는 서비스를 활성화합니다.
    ...
    ![cube-networking-addservice.png](../../assets/images/admin-guide/cube/networking/cube-networking-addservice.png)
...
8. TCP 및 UDP 항목에 포트 번호를 추가 한 후 ID 항목에서 서비스 이름을 확인하십시오.
    - ID 항목은 예약된 포트 서비스의 이름을 표시합니다. 이 포트를 자유롭게 사용할 수 있고 서버가 이 포트에서 통신 할 필요가 없는 경우 ID를 다시 쓸 수 있습니다.
9. ID 항목에 정의된 포트를 포함하여 서비스의 이름을 추가합니다.
10. **포트 추가** 버튼을 클릭합니다.

    ![cube-networking-addport.png](../../assets/images/admin-guide/cube/networking/cube-networking-addport.png)
...
4. 활성 영역의 테이블의 제거할 영역의 **삭제** 아이콘을 선택합니다.
    ...
    ![cube-networking-delzone.png](../../assets/images/admin-guide/cube/networking/cube-networking-delzone.png)
