...
## 가상머신 백업 복원
!!! info
    가상머신을 백업된 시점으로 복원하는 기능으로, 정지된 가상머신의 경우에만 가상머신 백업 복원이 가능합니다.

![가상머신 백업 복원 화면](../../assets/images/nas-backup/nas-backup-07.png){ .imgCenter .imgBorder }

- 스토리지 > 백업 메뉴에서 **가상머신 백업 복원** 버튼을 클릭하여 가상머신 백업 복원 화면을 볼러옵니다.
- **확인** 버튼을 클릭하여 복원합니다.

## 백업 볼륨 복원 및 연결
!!! info
    선택한 백업 볼륨은 선택한 가상머신의 데이터디스크에 연결됩니다.

![백업 볼륨 복원 및 연결 화면](../../assets/images/nas-backup/nas-backup-08.png){ .imgCenter .imgBorder }

- 스토리지 > 백업 메뉴에서 **백업 볼륨 복원 및 연결** 버튼을 클릭하여 백업 볼륨 복원 및 연결 화면을 볼러옵니다.
- **볼륨** 정보를 선택합니다.
- **VM** 정보를 선택합니다.
- **확인** 버튼을 클릭하여 복원 및 연결합니다.
