...
### SSH Key 생성 및 Affinity 그룹 생성
VM 생성하기 전, Anti Affinity 그룹을 생성하여 어느하나의 Tier에 속한 모든 VM들이 특정 호스트에 몰려 실행되지 않도록 합니다. 또한 VM에 대한 접근을 명확하게 제어하고 보안을 향상시킬 수 있는 SSH Key를 생성합니다.
...
1. 배포 인프라 선택 : `Zone`
2. 템플릿/ISO : `Rocky Linux 9.0 기본 이미지 템플릿`
3. 컴퓨트 오퍼링 : `1C-2GB-RBD-HA`
4. 데이터 디스크 : `100GB-WB-RBD`
5. 네트워크 : `web`
